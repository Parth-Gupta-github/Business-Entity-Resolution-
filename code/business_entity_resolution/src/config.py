...
class Config:
    ...
    BLOCKING_CHUNK_SIZE: int = 50_000   # S1 queries processed per chunk (reduced for memory)
    MIN_TFIDF_SCORE: float = 0.08       # ignore negligible cosine scores (raised to reduce memory)
